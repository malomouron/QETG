		...
		echo'		</head>
					<body>
						<div id="div1">
							...
							<form action="creer_question-2.php" method="get" id="form" name="form1">
								<div style="display: block;margin-left: -117px;">
									<label for="nombre_question">Combien voulez vous de question*: </label>
									<select name="nombre_question">
